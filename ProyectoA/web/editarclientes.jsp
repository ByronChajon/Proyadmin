...
<%
    ...
    if (request.getParameter("cod") != null) {
        cli = new Cliente();
        cli.setCliente(Integer.parseInt(request.getParameter("cod")));
        dao = new DAOCliente();
        try {
            cli = dao.leer(cli);
            if (cli == null) {
                msj = "No se pudo encontrar el cliente solicitado";
            }
        } catch (Exception e) {
            msj = "No se pudieron leer los datos del cliente";
        } finally {
            dao = null;
        }
    } else {
        ...
        if (request.getParameter("hCodigo") != null
            ...
            cli = new Cliente();
            cli.setCliente(Integer.parseInt(request.getParameter("hCodigo")));
            ...
            try {
                ...
                msj = e.getMessage()+ "No se pudo realizar la actualización";
            } finally {
                dao = null;
                cli = null;
            }
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <h4>Actualice los datos del cliente</h4>
                    <%
                        if (msj.length() > 0) {
                            out.print("div class=\"error\">" + msj + "</div>");
                        }
                    %>
                    <form name="frmClientes" action="editarclientes.jsp" method ="post">
                        <div class="form-group">
                            <input Type="hidden" name="hCodigo"
                                   value ="<%= (cli != null ? cli.getCliente() : "")%>">
                            ...
                            <a href="Clientes.jsp" class="btn btn-danger">Regresar</a>
                    </form>
