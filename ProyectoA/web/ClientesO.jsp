...
<%@page import="entidadesproyecto.Clienteo"%>
<%@page import="daoproyecto.DAOClienteo"%>
<%
    DAOClienteo dao;
    Clienteo cli = null;
    String msj = "";
    ...
    <body>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="bg-light border-right" id="sidebar-wrapper">
                <div class="sidebar-heading">Está usando SQL Oracle</div>
                ...
                <div class="container-fluid">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="txtCodigo" placeholder="Ingrese numero de cliente"
