...
import daoproyecto.DAOClienteo;

public final class ClientesO_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (request.getParameter("txtCodigo") != null
        ...
        cli = new Clienteo();
        cli.setCliente(Integer.parseInt(request.getParameter("txtCodigo")));
        ...
        try {
            dao.Registro(cli);
            response.sendRedirect("ClientesO.jsp");
        } catch (Exception e) {
      ...
      out.write("                    <a href=\"Oracle.jsp\" class=\"list-group-item list-group-item-action bg-light\">Cambiar Base de datos</a>\n");
      ...
      out.write("                            <input type=\"text\" class=\"form-control\" name=\"txtCodigo\" placeholder=\"Ingrese numero de cliente\"\n");
      out.write("                                   value =\"");
      out.print( (cli != null ? cli.getCliente() :"" ));
      out.write("\">\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        <div class=\"form-group\">\n");
      ...
      out.write("                                    ");
                                        ...
                                        DAOClienteo daoclien = new DAOClienteo();
                                        List<Clienteo> clientes = null;
                                        int i = 1;

                                        try {
                                            clientes = daoclien.listar();
                                            for (Clienteo clie : clientes) {
                                                out.print("<tr>"
                                                        + "<td>" + i + "</td>"
